...
public:
    Osc() : 
        value(50), 
        offsetInput(offset, "Offset", 0, 0, 1, 0, 1),
        angleInput(angle, "Angle", 0, 0, 1, 0, 360),
        lengthInput(length, "Length", 0, 0, 1, 0.5, 1.5) 
    {};

    Osc(float _x, float _y, float _w) : 
        value(50), 
        offsetInput(offset, "Offset", _x+_w/2, _y+10, 0.2, 0, 1),
